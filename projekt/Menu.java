			...
			switch (wybor)
			{
							...
							case "1" :
								...
								try {
									...
									if (b.wypozyczKsiazke(id_czytelnika, id_ksiazki)) {
										...
										System.out.println("Nie udał‚o się wypozyczyć książki.");
										System.out.println("Wciśnij enter aby kontynuować ");
										input.nextLine();
									}
				...
				case "3" : 
					do {
						...
						case "4" :
                                                        ...
                                                        System.out.println("|  5. Sortuj po egz. 0-MAX       |");
                                                        System.out.println("|  6. Sortuj po egz. MAX-0       |");
                                                        System.out.println("|                                |");
                                                        System.out.println("|  0. Powrót                     |");
                                                        System.out.println("+--------------------------------+");
                                                        System.out.print("Wybierz opcję pomiędzy 0 a 3: ");
				...
				case "4" : 
					do {
						...
						case "4" :
                                                        ...
                                                        System.out.println("|  5. Sortuj po id 0-MAX         |");
                                                        System.out.println("|  6. Sortuj po id MAX-0         |");
                                                        System.out.println("|                                |");
                                                        System.out.println("|  0. Powrót                     |");
                                                        System.out.println("+--------------------------------+");
                                                        System.out.print("Wybierz opcję pomiędzy 0 a 6: ");
				...
				case "5" : 
					do {
						...
						System.out.println("|  0. Powrót                     |");
						System.out.println("+--------------------------------+");
						System.out.print("Wybierz opcję pomiędzy 0 a 1: ");
						wybor = input.nextLine();
				...
				do {
					clear();
					System.out.println("+--------------------------------+");
					System.out.println("|----------Szukaj wedlug---------|");
					System.out.println("+--------------------------------+");
                                        System.out.println("|                                |");
					...
					switch (wybor)
					{
						...
						case "2" :
						System.out.print("Podaj tytuł ksiazki: ");
						parametr = input.nextLine();
